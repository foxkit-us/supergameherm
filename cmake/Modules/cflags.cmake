...
macro(set_cflags)
	if(CMAKE_C_COMPILER_ID STREQUAL "Clang")
		...
		test_c11()
		add_definitions("${SGHERM_C_STANDARD} -Wpedantic -Wall -Wextra")
		if(HAVE_POSIX)
	...
	elseif(CMAKE_C_COMPILER_ID STREQUAL "GNU")
		...
		test_c11()
		add_definitions("${SGHERM_C_STANDARD} -pedantic -Wall -Wextra")
		if(HAVE_POSIX)
	...
	elseif(CMAKE_C_COMPILER_ID STREQUAL "Intel")
		...
		test_c11()
		add_definitions("${SGHERM_C_STANDARD} -Wall -Wextra")
	elseif(CMAKE_CXX_COMPILER_ID STREQUAL "MSVC")
		set(HAVE_COMPILER_MSVC "1")
		add_definitions("/G5 /Gr /D _CRT_SECURE_NO_WARNINGS")
